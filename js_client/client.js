...
function handleLogin(event) {
    ...
    let loginFormData = new FormData(loginForm) // gets the form data from the form element
    ...
    fetch(loginEndpoint, options)  // similar to requests.posts -> returns a Promise
